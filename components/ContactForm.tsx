...
const SubmitButton = () => {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="w-full h-14 mt-4 flex items-center justify-center bg-accent text-primary-dark font-bold text-lg rounded-sm shadow-md transition-all hover:bg-accent-hover hover:scale-[1.02] disabled:opacity-70 disabled:hover:scale-100 disabled:cursor-not-allowed"
    >
...
const ContactForm = () => {
  // useActionState è l'hook di React 19 consigliato (sostituisce useFormState)
    ...
    <section id="contact" className="w-full bg-surface-muted py-16 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 rounded-lg overflow-hidden shadow-2xl border border-surface-muted/30">
          ...
          <div className="bg-surface p-10 lg:p-16 flex flex-col justify-center">
            <form action={formAction} className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  name="name"
                  required
                  className="w-full bg-transparent border-b-2 border-surface-muted py-2 text-text-main focus:outline-none focus:border-accent focus:ring-0 transition-colors"
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="relative">
                  <select
                    ...
                    required
                    defaultValue=""
                    className="w-full bg-transparent border-b-2 border-surface-muted py-2 text-text-main focus:outline-none focus:border-accent focus:ring-0 transition-colors appearance-none cursor-pointer"
                  >
              ...
              <div className="flex flex-col gap-1">
                ...
                <textarea
                  ...
                  name="message"
                  rows={3}
                  className="w-full bg-transparent border-b-2 border-surface-muted py-2 text-text-main focus:outline-none focus:border-accent focus:ring-0 transition-colors resize-none"
